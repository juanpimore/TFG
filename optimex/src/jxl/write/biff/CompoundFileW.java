 ...
 * of BBD blocks)
 */
public final class CompoundFileW extends BaseCompoundFile
{
  /**
   * The logger
   */
  private static Logger logger = Logger.getLogger(CompoundFileW.class);
   ...
   */
  public CompoundFileW(ExcelDataOutput data, int l, OutputStream os, 
